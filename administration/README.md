...
In addition to all the above features, you also have an analysis area within our system, and you can easily view information about: the overall performance of all employees in relation to the objectives linked to them, teams, performance and display of objectives and results keys linked to employees, hierarchical levels of your organization, and how the progress of all system objectives is progressing. Below are the images to show you each of these functions:

### Overall Performance

By selecting the Analyzes menu, you can already see the overall performance of the collaborators:

![](https://goo.gl/fNx64D)

### Teams

In this analysis you can know what each team is doing, understand:

![](https://goo.gl/1qdKoE)

Note that when filtering by the team "Escritório de Processos", the person responsible is linked, in this case it is "Alexandre Luna", attached to him, his OKR's.

::: tip NOTE
The "Process Office" team is the responsibility of "Alexandre Luna" and is also working on OKRA03 and its respective key results.
:::

### Employees and their key objectives and results

In this analysis you will be able to observe the OKR's of employees in the form of web:

![](https://goo.gl/4NWKGG)

Look again at the filter by collaborators "Alexandre Luna" and "Felipe Fernandes". This chart allows you to zoom in and zoom out and drag collaborators anywhere on the screen for easy viewing.

### Hierarchical levels

You may also want to know how your organization's performance is relative to each organizational hierarchical level by clicking on the "Níveis" button and these graphs will be displayed:

![](https://goo.gl/EsUkcq)

### Overall goal progress

Also visualize the overall progress of all the goals of your organization. Click the "Objetivos" button and get this page:

![](https://goo.gl/CSpR37)

### Share on your social networks

In addition to being able to view all of these types of reviews, you can share each of them on social networks. Just choose which analysis you want to share, click the share button and choose which form (Email, Facebook or WhatsApp), as shown in the images below:

Select the share button:

![](https://goo.gl/abphfh)

And choose the form you want to share:
